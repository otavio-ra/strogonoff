"""
Django settings for strogonoff project.
...
WSGI_APPLICATION = 'strogonoff.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './strogonoff.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
