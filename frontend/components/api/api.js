...
const api = {
    ...
    list_posts(){
        return get(`/api/list_receita`)
    },
    get_receita(){
        return get(`/api/get_receita`)
    },
    add_receita(receita, introducao, ingredientes, preparo, autor, foto){
        return post(`/api/createReceita`, {receita, introducao, ingredientes, preparo, autor, foto})
    }
}
export default api;
